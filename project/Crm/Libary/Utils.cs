...
namespace Jabinfo
{
	...
	class Utils
	{
		...
		public string HttpUpload(string action, string file)
		{
		...
		public object JsonTo(string json, Type targetType)
		{
			var jss = GetJSS();
		...
		public Dictionary<string, string> GetDictFromXml(string xml)
		{
